...
#computeMatrix scale-regions -S Niave1.bw Niave2.bw Niave3.bw Primed1.bw Primed2.bw Primed3.bw TSC1.bw TSC2.bw TSC3.bw -R AllTB_Primed_Gain.txt --beforeRegionStartLength 1000 --afterRegionStartLength 1000 --skipZeros -o tbpmatrixConvG.mat.gz
#plotProfile -m tbpmatrixConvG.mat.gz -out PT_lineG1.pdf --numPlotsPerRow 1 --startLabel "DMR-1kbp" --endLabel "DMR + 1kbp" --perGroup

#computeMatrix scale-regions -S Niave1.bw Niave2.bw Niave3.bw Primed1.bw Primed2.bw Primed3.bw TSC1.bw TSC2.bw TSC3.bw -R AllTB_Primed_Loss.txt --beforeRegionStartLength 1000 --afterRegionStartLength 1000 --skipZeros -o tbpmatrixConvL.mat.gz
...
#computeMatrix scale-regions -S Niave1.bw Niave2.bw Niave3.bw Primed1.bw Primed2.bw Primed3.bw TSC1.bw TSC2.bw TSC3.bw -R Output/AllTB_Niave_Gains_anno.txt --beforeRegionStartLength 1000 --afterRegionStartLength 1000 --skipZeros -o tbpmatrixConvG_2.mat.gz
...
#computeMatrix scale-regions -S Niave1.bw Niave2.bw Niave3.bw Primed1.bw Primed2.bw Primed3.bw TSC1.bw TSC2.bw TSC3.bw -R Output/AllTB_Niave_Loss_anno.txt --beforeRegionStartLength 1000 --afterRegionStartLength 1000 --skipZeros -o tbpmatrixConvL_2.mat.gz
...
#computeMatrix scale-regions -S Niave1.bw Niave2.bw Niave3.bw Primed1.bw Primed2.bw Primed3.bw TSC1.bw TSC2.bw TSC3.bw -R Output/AllPrimed_Niave_Gains_anno.txt --beforeRegionStartLength 1000 --afterRegionStartLength 1000 --skipZeros -o tbpmatrixConvG_3.mat.gz
...
computeMatrix scale-regions -S Niave1.bw Niave2.bw Niave3.bw Primed1.bw Primed2.bw Primed3.bw TSC1.bw TSC2.bw TSC3.bw -R Output/AllPrimed_Niave_Loss_anno.txt --beforeRegionStartLength 1000 --afterRegionStartLength 1000 --skipZeros -o tbpmatrixConvL_3.mat.gz
