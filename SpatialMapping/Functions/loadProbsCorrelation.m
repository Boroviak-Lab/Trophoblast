function [ConvCS6,ConvfCS6] = loadProbsCorrelation(OutputCS6,targInd,C,OBJ2)

inds = find(targInd~=0);
XYZ = OutputCS6.cleanX(inds,:);
Tissue = OutputCS6.cleanAnotaton(inds);
...
ind1 = find(strcmp(Tissue,'Am_CS6')==1);
ind2 = find(strcmp(Tissue,'EmDisc_CS6')==1 | strcmp(Tissue,'EmDisc_Gast_CS6')==1| strcmp(Tissue,'EmDisc_gast_CS6')==1);
ind3 = find(strcmp(Tissue,'VE_CS6')==1);
ind4 = find(strcmp(Tissue,'PGC_CS6')==1);
ind5 = find(strcmp(Tissue,'ExMes_CS6')==1);
ind6 = find(strcmp(Tissue,'Stalk_CS6')==1 | strcmp(Tissue,'EmDisc_stalk_CS6')==1 | strcmp(Tissue,'EmDisc_Stalk_CS6')==1);
ind7 = find(strcmp(Tissue,'SYS_CS6')==1);
ind8 = find(strcmp(Tissue,'Tb_CS6')==1);
...
for i = 1:size(C,2)
   ...
   Ymean6 = ([Ytrain6]);
    Ymean6= mean(Ymean6(find(Ymean6~=0)));
   Ymean7 = ([Ytrain7]);
   ...
   Ymean8 = ([Ytrain8]);
    ...
    Ytrainin6 = Ytrain6-Ymean6; %1 ./ ( 1 + exp(- k*(Ytrain2-Ymean) ));
    ...
    Ytrainin8 = Ytrain8-Ymean8; %1 ./ ( 1 + exp(- k*(Ytrain2-Ymean) ));
        ...
        par  = {@meanConst,@covSEiso,'likGauss',XtrainCS6(ind1,:), Ytrainin1(:,1)};
        hyp2 = feval(@minimize, hyp1, @gp, -1000, im1, par{:});
        [m_1 s_1] = gp(hyp2, 'infExact', @meanConst, @covSEiso, 'likGauss',  XtrainCS6(ind1,:), Ytrainin1(:,1), [OBJ2.vertices]/400);        
        ConvCS6{i,1} = m_1'+Ymean1;
        ConvfCS6{i,1} = s_1';  
        ...
        par  = {@meanConst,@covSEiso,'likGauss',XtrainCS6(ind2,:), Ytrainin2(:,1)};
        hyp2 = feval(@minimize, hyp1, @gp, -1000, im1, par{:});
        [m_1 s_1] = gp(hyp2, 'infExact', @meanConst, @covSEiso, 'likGauss',  XtrainCS6(ind2,:), Ytrainin2(:,1), [OBJ2.vertices]/400);        
        ConvCS6{i,2} = m_1'+Ymean2;
        ConvfCS6{i,2} = s_1';
      ...
      %substrain = find(LabBinCS6==uLab(j));      
        ...
        par  = {@meanConst,@covSEiso,'likGauss',XtrainCS6(ind3,:), Ytrainin3(:,1)};
        hyp2 = feval(@minimize, hyp1, @gp, -1000, im1, par{:});
        [m_1 s_1] = gp(hyp2, 'infExact', @meanConst, @covSEiso, 'likGauss',  XtrainCS6(ind3,:), Ytrainin3(:,1), [OBJ2.vertices]/400);        
        ConvCS6{i,3} = m_1'+Ymean3;
        ConvfCS6{i,3} = s_1';    
      ...
      %substrain = find(LabBinCS6==uLab(j));      
        ...
        hyp1.lik  = [log(0.1/2)];  
        hyp1.mean = mean(Ytrainin3(:,1));       
        par  = {@meanConst,@covSEiso,'likGauss',XtrainCS6(ind4,:), Ytrainin4(:,1)};
        hyp2 = feval(@minimize, hyp1, @gp, -1000, im1, par{:});
        [m_1 s_1] = gp(hyp2, 'infExact', @meanConst, @covSEiso, 'likGauss',  XtrainCS6(ind4,:), Ytrainin4(:,1), [OBJ2.vertices]/400);        
        ConvCS6{i,4} = m_1'+Ymean4;
        ConvfCS6{i,4} = s_1';    
      ...
      %substrain = find(LabBinCS6==uLab(j));      
        ...
        hyp1.lik  = [log(0.1/2)];  
        hyp1.mean = mean(Ytrainin3(:,1));       
        par  = {@meanConst,@covSEiso,'likGauss',XtrainCS6(ind5,:), Ytrainin5(:,1)};
        hyp2 = feval(@minimize, hyp1, @gp, -1000, im1, par{:});
        [m_1 s_1] = gp(hyp2, 'infExact', @meanConst, @covSEiso, 'likGauss',  XtrainCS6(ind5,:), Ytrainin5(:,1), [OBJ2.vertices]/400);        
        ConvCS6{i,5} = m_1'+Ymean5;
        ConvfCS6{i,5} = s_1';    

      %substrain = find(LabBinCS6==uLab(j));      
        hyp1.cov  = [log(2); log(0.1) ]; 
        hyp1.lik  = [log(0.1/2)];  
        hyp1.mean = mean(Ytrainin6(:,1));       
        par  = {@meanConst,@covSEiso,'likGauss',XtrainCS6(ind6,:), Ytrainin6(:,1)};
        hyp2 = feval(@minimize, hyp1, @gp, -1000, im1, par{:});
        [m_1 s_1] = gp(hyp2, 'infExact', @meanConst, @covSEiso, 'likGauss',  XtrainCS6(ind6,:), Ytrainin6(:,1), [OBJ2.vertices]/400);        
        ConvCS6{i,6} = m_1'+Ymean6;
        ConvfCS6{i,6} = s_1';    
        
      %substrain = find(LabBinCS6==uLab(j));      
        hyp1.cov  = [log(2); log(0.1) ]; 
        hyp1.lik  = [log(0.1/2)];  
        hyp1.mean = mean(Ytrainin7(:,1));       
        par  = {@meanConst,@covSEiso,'likGauss',XtrainCS6(ind7,:), Ytrainin7(:,1)};
        hyp2 = feval(@minimize, hyp1, @gp, -1000, im1, par{:});
        [m_1 s_1] = gp(hyp2, 'infExact', @meanConst, @covSEiso, 'likGauss',  XtrainCS6(ind7,:), Ytrainin7(:,1), [OBJ2.vertices]/400);        
        ConvCS6{i,7} = m_1'+Ymean7;
        ConvfCS6{i,7} = s_1';     
      ...
      %substrain = find(LabBinCS6==uLab(j));      
        ...
        par  = {@meanConst,@covSEiso,'likGauss',XtrainCS6(ind8,:), Ytrainin8(:,1)};
        hyp2 = feval(@minimize, hyp1, @gp, -1000, im1, par{:});
        [m_1 s_1] = gp(hyp2, 'infExact', @meanConst, @covSEiso, 'likGauss',  XtrainCS6(ind8,:), Ytrainin8(:,1), [OBJ2.vertices]/400);        
        ConvCS6{i,8} = m_1'+Ymean8;
        ConvfCS6{i,8} = s_1';            
